    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <form action="/logout" method="post">
                                    @csrf
                                    <button type="submit" class="dropdown-item"><i class="bi bi-box-arrow-up-right"></i>
                                        Logout</button>
                                </form>
                            </li>
                        </ul>
                ...
                @else
                    <li class="nav-item">
                        <a class="nav-link {{ $active === 'login' ? 'active' : '' }} btn btn-outline-primary"
                            href="/login">Login <i class="bi bi-box-arrow-in-up-right"></i></a>
                    </li>
                @endauth
            </ul>
        </div>
